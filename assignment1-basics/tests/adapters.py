...
def run_multihead_self_attention(
    ...
    mha.o_proj.w.data = o_proj_weight
...
def run_multihead_self_attention_with_rope(
    ...
    """
    # raise NotImplementedError
    from cs336_basics.module import multihead_self_attention_with_rope

    mha = multihead_self_attention_with_rope(d_model,num_heads,theta,max_seq_len)
    mha.q_proj.w.data = q_proj_weight
    mha.k_proj.w.data = k_proj_weight
    mha.v_proj.w.data = v_proj_weight
    mha.o_proj.w.data = o_proj_weight
